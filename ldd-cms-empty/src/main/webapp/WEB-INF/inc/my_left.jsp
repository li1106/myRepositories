...
<div class="avatar">
	...
	<div class="list-group">
	  <a href="/my/blogs?status=1" class="list-group-item ${param.module eq 'blogs' ? 'active' : ''}">我的文章<span class="badge">3</span> </a>
	  ...
	  <a href="/my/useredit" class="list-group-item ${param.module eq 'useredit' ? 'active' : ''}">个人设置</a>
	</div>
</div>