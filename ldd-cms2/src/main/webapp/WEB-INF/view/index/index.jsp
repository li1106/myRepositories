...
<%@ page language="java" import="com.ldd.cms.utils.*"%>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<p class="blog_item_footer">
										...
										作者：${c.username}&nbsp;&nbsp;&nbsp; <span
											class="glyphicon glyphicon-time" title="发布时间"></span>
										发布：&nbsp;
					...
					<div id="article">
						<c:forEach items="${articles}" var="c">
							<div class="media">
								...
								<div class="media-body">
									<h5>
										<a href="javascript:detail(${c.id },${c.channelId })">${c.title }</a>
									</h5>
									<p class="blog_item_footer">
						...
						<ol>
							<c:forEach items="${lasts}" var="article">
								<li class="text-truncate"><a
									href="javascript:detail(${article.id },${article.channelId })">${article.title}</a></li>
							</c:forEach>
						</ol>
					</div>
				</div>
					...
					<div class="card-body">
						<c:forEach items="${pics}" var="p">
							<a href="javascript:getPic(${p.id })"> <img alt=""
								src="/pic/${p.picture}" width="50px" height="50px">
							</a>
						</c:forEach>
					</div>
				</div>
