...
import com.ldd.cms.service.UserService;
import com.ldd.cms.utils.CMSConstant;
import com.ldd.cms.utils.CMSRuntimeException;
import com.ldd.cms.vo.UserVO;
...
//	@RequestMapping( value="toReg",method=RequestMethod.GET)
	...
	public String login(User user,HttpSession session,HttpServletResponse response,Model model) throws IOException {
